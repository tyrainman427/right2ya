# Generated by Django 3.2.16 on 2023-05-18 07:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('creating', 'Creating'), ('processing', 'Processing'), ('ready', 'ready'), ('picking', 'Picking'), ('Delivering Order', 'Delivering'), ('completed', 'Completed'), ('canceled', 'Canceled')], default='creating', max_length=20)),
        ...
        migrations.AddField(
            model_name='customer',
            name='company',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='company', to='core.restaurant'),
        ),
        migrations.AddField(
            model_name='customer',
            name='user',
